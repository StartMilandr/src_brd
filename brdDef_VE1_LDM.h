...
//  --------------  Buttons Definition  ------------
  ...
  // PD6 - BOT(4) SA6
    ...
    #define BRD_BTN_PORT_SEL       MDR_PORTD
    #define BRD_BTN_PIN_SEL        PORT_Pin_2  //  SA2

    #define BRD_BTN_PORT_UP        MDR_PORTD
    #define BRD_BTN_PIN_UP         PORT_Pin_3  //  SA3
	
    #define BRD_BTN_PORT_RIGHT     MDR_PORTD
    #define BRD_BTN_PIN_RIGHT      PORT_Pin_6  //  SA6
	
    #define BRD_BTN_PORT_DOWN      MDR_PORTD
    #define BRD_BTN_PIN_DOWN       PORT_Pin_4  //  SA4
	
    #define BRD_BTN_PORT_LEFT      MDR_PORTD
    #define BRD_BTN_PIN_LEFT       PORT_Pin_5  //  SA5

//    // for Initialization
    #define BRD_BTNs_PORT_CLK      RST_CLK_PCLK_PORTD
    #define BRD_BTNs_PORT_MASK     MDR_PORTD
...
//  ----------    LEDs Definition -------------
    ...
    #define BRD_LED_1              PORT_Pin_0   // PD0  - LED(4)
    #define BRD_LED_2              PORT_Pin_7   // PD7  - LED(5)
    #define BRD_LED_3              PORT_Pin_12  // PD12 - LED(6)
  
    #define BRD_LED_Pins        (BRD_LED_1 | BRD_LED_2 | BRD_LED_3)
